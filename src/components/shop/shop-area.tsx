                ...
                >
                  ...
                  <div className="tpshopitem__content text-center">
                    <span className="tpshopitem__title mb-5">
                      <Link href="/src/pages/product-details">{item.title}</Link>
                    </span>
                    <p>${item.price}</p>
              ...
              <div className="basic-pagination text-center mt-15">
                <nav>
                  <ul>
                    ...
                    <li>
                      <Link href="/src/pages/product-details">1</Link>
                    </li>
                    <li>
                      <span className="current">2</span>
                    </li>
                    <li>
                      <Link href="/src/pages/product-details">3</Link>
                    </li>
                    <li>
                      <Link href="/src/pages/product-details">...</Link>
                    </li>
                    <li>
                      <Link href="/src/pages/product-details">
