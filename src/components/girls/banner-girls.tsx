        ...
        <div className="row align-items-center">
          <div className="col-xl-7 col-lg-12 col-md-12 col-12">
            <div className={sC.tpBreadcrumb}>
              <h2 className={sC.title}>{t('girls.title')}</h2>
              <div className={sC.group}>
                ...
                <div
                  className={cn(sC.element, selected_category === '2010 - 2011' && sC.selectedCategory)}
                  onClick={on2010_2011}
                >
                  {t('girls.year2010_2011')}
                </div>
                <div
                  className={cn(sC.element, selected_category === '2012 - 2013' && sC.selectedCategory)}
                  onClick={on2012_2013}
                >
                  {t('girls.year2012_2013')}
                </div>
              </div>
            </div>
          </div>
